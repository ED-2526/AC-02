...
from double_step_svm import calcula_prediccio_svm_double_step
from svm import avalua_prediccions_svm
import pandas as pd
import numpy as np
...
#DADES DE TEST
# 4.Prediccions
y_pred = calcula_prediccio_svm_double_step(
                        x_train, y_train, x_test, classes_postres=["DOLCOS_CREMOSOS", "DOLCOS_BARRA_PASTIS", "DOLCOS_FREGITS", "PA"], C_primera=0.5, C_segona=1.0, gamma=gamma, kernel='hist_intersection')
